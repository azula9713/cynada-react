          ...
          <div className="row">
            <div className="col-12 col-lg-10 col-xl-8">
              ...
              <h1 className="display-4 text-white font-weight-bold">
                Delivering <span id="nextgen">Next-Gen</span> Solutions Today
              </h1>
              {/* Text */}
              <p id="elixr" className="lead text-light">
                We at CYNADA have the elixir vita with our IT solutions that can
                make your unique idea stand out among others.
              </p>
              {/* Buttons */}{" "}
