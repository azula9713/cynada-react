              ...
              <div className="row">
                  ...
                  <div className="card border-0 bg-transparent">
                    ...
                    <div className="card-body pt-5"> <Link className="d-inline-block text-muted mb-2" to="/">Sass</Link>
                      <h2 className="h5 font-weight-medium">
                        <Link className="link-title" to="/blog-single">Cynada Perfect Performance landing Page</Link>
                      </h2>
                ...
                <div className="col-12 col-lg-4">
                  ...
                  <div className="mt-11">
                    ...
                    <div> <Link className="btn btn-link text-dark btn-sm bg-primary-soft m-1" to="/">Cynada</Link>
