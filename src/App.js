...
class App extends React.Component {
  ...
  setHeader(pathname) {
    let pathArray = pathname.split('/');
    return `/${pathArray[1]}` === '/index2' ? true : `/${pathArray[1]}` === '/' ? true : `/${pathArray[1]}` === '/index3' ? true : `/${pathArray[1]}` === '/index4' ? true : `/${pathArray[1]}` === '/index5' ? true : `/${pathArray[1]}` === '/index9' ? true  : false;
      ...
      <Fragment>
        ...
        <div className="page-wrapper">
          ...
          <Switch>
            ...
            <Route path="/about-us2" component={Aboutus} />
